...
jQuery(document).ready(function ($) {
  function initFlickity() {
    ...
    var $slider = $(".st-testimonials__all");
    var $cells = $slider.find(".carousel-cell");
    if (windowWidth >= 834.6 && $cells.length < 3) {
      if ($slider.hasClass("flickity-enabled")) {
        $slider.closest(".st-testimonials").addClass("no-flickity");
        $slider.flickity("destroy").removeClass("flickity-enabled");
      }
    } else if (windowWidth < 834.6 || $cells.length >= 2) {
      if (!$slider.hasClass("flickity-enabled")) {
        $slider.closest(".st-testimonials").removeClass("no-flickity");
        $slider.flickity({
        ...
        $(".st-testimonials__buttons").hover(function () {
...
jQuery(document).ready(function ($) {
  ...
  $(".st-details__toggle-title").click(function () {
    ...
    $(this).closest(".st-details__wrap").find(".st-details__body").slideToggle(900);
  });
  ...
  function handleLogoCloning() {
    if ($(window).width() <= 834.5) {
      if (!$(".st-customers__logos-wrap").hasClass("cloned")) {
        var copy = $(".st-customers__logos").clone();
        $(".st-customers__logos-wrap").append(copy);
        $(".st-customers__logos-wrap").addClass("cloned");
      }
    } else {
      if ($(".st-customers__logos-wrap").hasClass("cloned")) {
        $(".st-customers__logos-wrap").find(".st-customers__logos").last().remove();
