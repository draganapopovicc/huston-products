...
function stier_setup() {
	...
	register_nav_menus(
		array(
			...
			'footer' => esc_html__( 'Footer Bottom Menu', 'stier' ),
			'products' => esc_html__( 'Footer Product Menu', 'stier' ),
			'information' => esc_html__( 'Footer Information Menu', 'stier' ),
			)
	);
...
function stier_login_styles() {
    wp_enqueue_style( 'login-style', get_template_directory_uri() . '/assets/dist/wp-login-dark.css' );
}
