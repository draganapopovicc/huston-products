...
add_filter( 'block_categories_all' , function( $categories ) {
	...
	$categories[] = array(
		'slug'  => 'houston-products',
		'title' => 'Houston Products'
	);
...
function register_acf_blocks() {
	...
	register_block_type( __DIR__ . '/../blocks/home-carousel');
    register_block_type( __DIR__ . '/../blocks/our-mission');
    register_block_type( __DIR__ . '/../blocks/about-us');
    register_block_type( __DIR__ . '/../blocks/technical-details' );
    register_block_type( __DIR__ . '/../blocks/contact' );
    register_block_type( __DIR__ . '/../blocks/request-quote' );
    register_block_type( __DIR__ . '/../blocks/inner-hero' );
    register_block_type( __DIR__ . '/../blocks/our-history' );
    register_block_type( __DIR__ . '/../blocks/products' );
    register_block_type( __DIR__ . '/../blocks/product-action' );
    register_block_type( __DIR__ . '/../blocks/single-product' );
}
